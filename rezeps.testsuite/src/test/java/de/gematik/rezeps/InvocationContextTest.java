...
public class InvocationContextTest {
  ...
  @Test()
  public void shouldBeValidInvocationContext() {
    InvocationContext invocationContext = new InvocationContext(MANDANT, CLIENT_SYSTEM, WORKPLACE);
    Assert.assertTrue(
        MessageFormat.format(
            "Fehler beim validieren des Aufrufkontextes: Mandant: {0},ClientSystem: {1},Workplace: {2} ",
            invocationContext.isValidInvocationContext(),
