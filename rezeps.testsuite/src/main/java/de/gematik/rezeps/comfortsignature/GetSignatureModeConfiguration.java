 ...
 */
@Configuration
public class GetSignatureModeConfiguration {

  @Bean
  public Jaxb2Marshaller getSignatureModeMarshaller() {
  ...
  @Bean
  public PerformGetSignatureMode performGetSignatureMode(Jaxb2Marshaller getSignatureModeMarshaller)
      throws IOException, UnrecoverableKeyException, CertificateException, NoSuchAlgorithmException,
          KeyStoreException, KeyManagementException {

    PerformGetSignatureMode client = new PerformGetSignatureMode();
    client.setDefaultUri(KonnektorHelper.determineSignatureServiceEndpoint());
    client.setMarshaller(getSignatureModeMarshaller);
    client.setUnmarshaller(getSignatureModeMarshaller);
