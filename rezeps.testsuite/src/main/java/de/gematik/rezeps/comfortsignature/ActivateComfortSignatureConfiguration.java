 ...
 */
@Configuration
public class ActivateComfortSignatureConfiguration {

  @Bean
  public Jaxb2Marshaller activateComfortSignatureMarshaller() {
  ...
  @Bean
  public PerformActivateComfortSignature performActivateComfortSignature(
      Jaxb2Marshaller activateComfortSignatureMarshaller)
      throws IOException, UnrecoverableKeyException, CertificateException, NoSuchAlgorithmException,
          KeyStoreException, KeyManagementException {

    PerformActivateComfortSignature client = new PerformActivateComfortSignature();
    client.setDefaultUri(KonnektorHelper.determineSignatureServiceEndpoint());
    client.setMarshaller(activateComfortSignatureMarshaller);
    client.setUnmarshaller(activateComfortSignatureMarshaller);
